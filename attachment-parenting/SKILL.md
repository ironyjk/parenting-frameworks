...
| Command | Description |
|---------|-------------|
| `/attachment` | Full attachment-based analysis of a parenting situation |
| `/attachment:style` | Assess attachment dynamics in a described interaction |
| `/attachment:repair` | Guide a repair conversation after a rupture |
| `/attachment:circle` | Apply the Circle of Security model |
| `/attachment:4s` | Evaluate a situation through Siegel's 4 S's framework |
...
### 2. Avoidant/Dismissing Attachment (~20%)
...
### 3. Anxious-Resistant/Ambivalent Attachment (~15%)
...
**Seen:** "You seem worried about the test tomorrow."
**Not seen:** "Stop fidgeting and go to bed." (addresses behavior, misses the feeling)
...
**Soothed:** "That was scary. Let's breathe together. In... out... I'm right here."
**Not soothed:** "Stop crying. There's nothing to be afraid of."
...
**Safe:** The parent manages their own anger so the child is never the target of rage.
**Not safe:** "If you don't stop, I swear I'll—" (threat becomes the danger)

### 4. Secure (Internal Security)
...
1. **Perceive** the child's signals accurately
2. **Interpret** them correctly (not project adult meaning)
3. **Respond** promptly and appropriately
4. **Be consistent** (not perfect — consistent enough)
...
1. **Confusing attachment parenting with permissive parenting** — secure attachment includes boundaries. The child needs a parent who is "bigger, stronger, wiser, AND kind."
2. **Believing attachment is set in stone** — attachment can be earned at any age. It is never too late.
3. **Pursuing perfection** — the goal is not 100% attunement. Research suggests 30-50% attunement with consistent repair is sufficient for secure attachment.
4. **Using attachment to guilt-trip** — "You'll damage your child's attachment if you go to work" is a misuse of the theory.
5. **Ignoring your own attachment history** — unresolved patterns from your childhood will replicate unless made conscious.
6. **Repair without change** — "I'm sorry" without behavioral change is not repair; it's a pattern.
7. **Always being the safe haven, never the secure base** — overprotection inhibits exploration.
8. **Treating avoidant children as "easy"** — they're not fine; they've learned to suppress. Look deeper.
